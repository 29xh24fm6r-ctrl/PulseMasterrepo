...
export default function AddTaskModal({ personId, personName, onClose, onSuccess }: AddTaskModalProps) {
  const [title, setTitle] = useState("");
  const [dueDate, setDueDate] = useState("");
  const [loading, setLoading] = useState(false);
  const [error, setError] = useState<string | null>(null);

  // Convert YYYY-MM-DD to ISO at local noon to avoid timezone date shifting
