// Finance Domain Context Builder
...
/**
 * Build finance domain context for Cortex
 */
export async function buildFinanceDomainContext(
  userId: string
  ...
  try {
    ...
    console.warn("[FinanceDomain] Failed to build context:", err);
    return {
      accountsSummary: {
        totalBalance: 0,
        availableBalance: 0,
