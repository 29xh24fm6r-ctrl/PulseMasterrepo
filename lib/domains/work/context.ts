...
/**
 * Build work domain context for Cortex
 */
export async function buildWorkDomainContext(
  userId: string
  ...
  try {
    ...
    console.warn("[WorkDomain] Failed to build context:", err);
    return {
      queue: [],
      activeProjects: [],
      focusSessions: 0,
