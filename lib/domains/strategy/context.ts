// Strategy Domain Context Builder
...
/**
 * Build strategy domain context for Cortex
 */
export async function buildStrategyDomainContext(
  userId: string
  ...
  try {
    ...
    console.warn("[StrategyDomain] Failed to build context:", err);
    return {
      arcs: [],
      currentQuarterFocus: {
        themes: [],
