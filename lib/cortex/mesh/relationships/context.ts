// Relationships Domain Context Builder (Mesh v2)
...
/**
 * Build relationships domain context for Cognitive Mesh
 */
export async function buildRelationshipsContext(
  userId: string
  ...
  try {
    ...
    console.warn("[RelationshipsMesh] Failed to build context:", err);
    return {
      keyPeople: [],
      healthScores: [],
      upcomingInteractions: [],
