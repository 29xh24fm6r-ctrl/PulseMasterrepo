...
function generateNotifications(): Notification[] {
  ...
  return [
    ...
    { id: "n5", type: "identity", title: "Archetype Ready!", message: "Stoic reached 500+ resonance", icon: "🏛️", color: "#a855f7", read: true, actionUrl: "/bridge", createdAt: new Date(now.getTime() - 24 * 60 * 60 * 1000).toISOString() },
  ];
}
